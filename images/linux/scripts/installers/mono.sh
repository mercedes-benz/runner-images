...
# TODO maigl this stalls if we don't set the proxy flag -> 
# apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --keyserver-options http-proxy=http://security-proxy.emea.svc.corpintra.net:3128 --recv-keys 3FA7E0328081BFF6A14DA29AA6A19B38D3D831EF
